...
parser = argparse.ArgumentParser(description='Transforma CLI FortiGate IPv4 Object Firewall Service Group para CSV')
...
with open(Input) as In:
    ...
    while line:
        ...
        if command[0] == 'config': config(cli, 'config firewall service group')
